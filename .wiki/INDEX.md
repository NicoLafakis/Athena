...
- [Blind-first Jarvis upgrade](features/blind-first-jarvis/00-overview.md) - Canonical Tier 3 package, now in implementation. The Phase 1 passive semantic subscriber provides versioned per-run state, runtime-over-agent truth, and redacted trace provenance; calm announcements, append-only screen-reader presentation, bounded experiential guidance, governed proactivity, and opt-in watchers/voice follow in the ordered plan.
