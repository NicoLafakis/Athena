...
- [Blind-first Jarvis upgrade](features/blind-first-jarvis/00-overview.md) - Canonical Tier 3 research and implementation package for evidence-backed semantic state, calm priority-aware announcements, an append-only screen-reader presentation, bounded experiential guidance, governed proactivity, and opt-in watchers/voice. All component plans, decisions, tests, rollout, risks, and ordered tasks live in this package.
